    ...
    <div class="wrapper">
      <div class="container">
        <div class="cart-box">
          ...
          <ul class="cart-item-list">
            ...
            >
              ...
              <div class="item-total">{{ item.cartTotalPrice }}</div>
              <div class="item-del" @click="deleProduct(item)"></div>
            </li>
          </ul>
        </div>
        <div class="order-wrap clearfix">
          ...
          <div class="total fr">
            合计：<span>{{ item.cartTotalPrice }}</span
            >元
...
export default {
  ...
  methods: {
    ...
    //是否商品全选
    toggleAll() {
      let url = this.allChecked ? "/carts/unSelectedAll" : "/carts/selectedAll";
