        ...
        <div class="edit-wrap">
          ...
          <div class="item">
            ...
            <textarea
              ...
              cols="30"
              rows="10"
              v-model="checkedItem.receiverAddres"
            ></textarea>
          </div>
          <div class="item">
            <input
...
export default {
  ...
  data() {
    return {
      ...
      cartTotalPrice: 0, //购物车中商品总金额，默认为0
      count: 0, //选中的商品结算数量
  ...
  methods: {
    ...
    submitAddress() {
      ...
      if (userAction == 0) {
        ...
        params = {
          ...
          receiverAddres: checkedItem.receiverAddres,
    ...
    getCartList() {
      this.axios.get("/carts").then((res) => {
        //获取购物车中所有商品数据
        this.list = res.cartProductList;
        //获取购物车中已选中的商品总价格
        this.cartTotalPrice = res.cartTotalPrice;
        //获取购物车中已选择的商品
        this.cartList = this.list.filter((item) => item.productSelected);
