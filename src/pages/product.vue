  ...
  <div class="product">
    ...
    <div class="content">
      ...
      <div class="item-video">
        ...
        <div class="video-box" v-show="showSlide == 'slideDown'">
...
export default {
  ...
  methods: {
    getProductInfo() {
      // 获取此页面请求的id，然后将请求到的结果赋值给product,然后获取值后将子组件里的值进行双向绑定。eg.title
    ...
    buy() {
      let id = this.$route.params.id;
      this.$router.push(`/detail/${id}`).then(() => {});
    },
    closeVideo() {
